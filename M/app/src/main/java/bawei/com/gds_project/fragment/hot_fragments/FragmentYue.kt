 ...
 */
class FragmentYue : BaseFragment(), IHotView {

    lateinit var recycle : RecyclerView


    override fun getLayoutResources(): Int {
        return R.layout.fragments_hot_yue
    }

    override fun initView() {
        recycle = view!!.findViewById<RecyclerView>(R.id.fragment_hot_yue_recycle)
        var presenter : IHotPresenter?= HotPresenter(this)
        presenter?.relevance(context,"monthly")
