...
data class Item(
    ...
    data class Data(
        ...
        val provider: IndexBean.Provider,
        val category: String, //广告
        val author: IndexBean.Author,
        val cover: IndexBean.Cover,
        ...
        val playInfo: List<IndexBean.PlayInfo>,
        val consumption: IndexBean.Consumption,
        val campaign: Any, //null
        val waterMarks: Any, //null
        val adTrack: Any, //null
        val tags: List<IndexBean.Tag>,
